  ...
  crossorigin="anonymous"></script>
	...
	<body>
		...
		<div class="main_wrapper">
			...
			do{
			$query1="SELECT * from fidenza ORDER BY rand() limit 1";
			$sql1=mysqli_query($con, $query1);
			$row1=mysqli_fetch_array($sql1, MYSQLI_ASSOC);

			$query2="SELECT * from fidenza ORDER BY rand() limit 1";
			...
			?>
				...
				<div id="photoRandom">
					<a class="link1" href="vote.php?table=fidenza&id1=<?php echo $row1['id'] ?>&amp;id2=<?php echo $row2['id'] ?>&amp;photo=first"><img class="image-lg" src="fidenza/<?php echo $row1['photo'] ?>" /></a>
					<p id="or">OR</p>
					<a class="link2"href="vote.php?table=fidenza&id2=<?php echo $row2['id'] ?>&amp;id1=<?php echo $row1['id'] ?>&amp;photo=second"><img class="image-lg" src="fidenza/<?php echo $row2['photo'] ?>" /></a>
				</div>
...
<center>
		...
		<a href="fidenzaranking.php" class="rank" style="font-size:22px;"><strong>All Ratings</strong></a>
</center>

    <center>
    <?php
	$i=1;
	$query="Select * from fidenza order by rating desc limit 50";
